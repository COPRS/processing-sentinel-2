...
@Slf4j
@Service
public class MessageService extends AbstractEWMessageService<L0cExecutionInput> {
    ...
    public Set<ProcessingMessage> build(L0cExecutionInput l0cExecutionInput, Map<ProductFamily, Set<FileInfo>> fileInfosByFamily, String... options) {
        ...
        Set<ProcessingMessage> messages = buildMessages(fileInfosByFamily, l0cExecutionInput);

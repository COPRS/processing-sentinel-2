...
class L1abEWSetupServiceTest extends AbstractTest {

    @Mock
    private L1abEWCleanupService cleanupService;
    @Mock
    ...
    public void setup() throws Exception {
        setupService = new L1abEWSetupService(cleanupService, sharedProperties);
    }

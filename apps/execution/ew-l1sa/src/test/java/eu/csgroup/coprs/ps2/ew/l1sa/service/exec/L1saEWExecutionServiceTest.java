...
class L1saEWExecutionServiceTest extends AbstractTest {
    ...
    public void setup() throws Exception {
        executionService = new L1saEWExecutionService(sharedProperties);
    }
    ...
    @Test
    void getLevel() {
        assertEquals("L1sa", executionService.getLevel());
    }

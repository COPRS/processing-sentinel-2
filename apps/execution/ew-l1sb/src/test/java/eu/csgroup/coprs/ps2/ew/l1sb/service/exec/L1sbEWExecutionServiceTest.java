...
class L1sbEWExecutionServiceTest extends AbstractTest {
    ...
    public void setup() throws Exception {
        executionService = new L1sbEWExecutionService(sharedProperties);
    }
    ...
    @Test
    void getLevel() {
        assertEquals("L1sb", executionService.getLevel());
    }

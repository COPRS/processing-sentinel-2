...
class L2dsEWExecutionServiceTest extends AbstractTest {
    ...
    public void setup() throws Exception {
        executionService = new L2dsEWExecutionService(sharedProperties);
    }
    ...
    @Test
    void getLevel() {
        assertEquals("L2A_DS", executionService.getLevel());
    }

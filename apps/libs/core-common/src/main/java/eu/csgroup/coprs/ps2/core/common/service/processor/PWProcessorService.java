...
@Slf4j
public abstract class PWProcessorService<T extends ExecutionInput, S extends PWItem, V extends PWItemService<S>> extends ProcessorService {

    protected final PWInputManagementService inputManagementService;
    protected final PWItemManagementService<S, V> itemManagementService;
    protected final PWExecutionInputService<T, S> executionInputService;
    protected final PWMessageService<T> messageService;

    protected PWProcessorService(PWInputManagementService inputManagementService, PWItemManagementService<S, V> itemManagementService,

...
public class InputService {
    ...
    public List<Path> getDatastrips(String inputFolder) {
        ...
        FileOperationUtils.findFolders(l0uDumpPath, FileParameters.DT_REGEX)
                .forEach(path -> {
                    final List<Path> datastripFolders = FileOperationUtils.findFolders(path.resolve("DS"), FileParameters.DS_REGEX);
